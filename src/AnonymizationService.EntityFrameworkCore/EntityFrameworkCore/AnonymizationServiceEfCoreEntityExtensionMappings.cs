...
public static class AnonymizationServiceEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
             ...
             * USE AnonymizationServiceModuleExtensionConfigurator CLASS (in the Domain.Shared project)
