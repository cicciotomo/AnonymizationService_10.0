...
namespace AnonymizationService.Migrations
{
    ...
    [Migration("20220805072318_AddQuartzTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnonymizationService.Patients.Patient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AppPatient", (string)null);
                });

            modelBuilder.Entity("AnonymizationService.StateMachines.Base.BaseStateMachine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppBaseStateMachine", (string)null);
                });
            ...
            modelBuilder.Entity("AnonymizationService.StateMachines.Clinical.ClinicalStateMachine", b =>
                {
                    b.HasBaseType("AnonymizationService.StateMachines.Base.BaseStateMachine");

                    b.ToTable("AppClinicalStateMachine", (string)null);
                });
            ...
            modelBuilder.Entity("AnonymizationService.StateMachines.Dicom.DicomStateMachine", b =>
                {
                    ...
                    b.ToTable("AppDicomStateMachine", (string)null);
                });
            ...
            modelBuilder.Entity("AnonymizationService.StateMachines.Laboratory.LaboratoryStateMachine", b =>
                {
                    ...
                    b.ToTable("AppLaboratoryStateMachine", (string)null);
                });
            ...
            modelBuilder.Entity("AnonymizationService.StateMachines.Clinical.ClinicalStateMachine", b =>
                {
                    b.HasOne("AnonymizationService.StateMachines.Base.BaseStateMachine", null)
                        .WithOne()
